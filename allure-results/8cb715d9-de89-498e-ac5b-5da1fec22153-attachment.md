            ...
            - tabpanel "Sign In" [ref=e68]:
              - generic [ref=e69]:
                - generic [ref=e70]:
                  ...
                  - generic [ref=e71]:
                    - img [ref=e73]
                    - textbox "Email Address" [disabled] [ref=e76]:
                ...
                - generic [ref=e77]:
                  ...
                  - generic [ref=e78]:
                    - img [ref=e80]
                    - textbox "Password" [disabled] [ref=e83]:
                      - /placeholder: ••••••••
                      - text: Nippy63!
                - button "Signing in..." [disabled]:
                  - img
                  - text: Signing in...
          - paragraph [ref=e85]: By continuing, you agree to our Terms of Service and Privacy Policy.
    - region "Notifications (F8)":
      - list
    - region "Notifications alt+T"
  - complementary "Edit with Lovable" [ref=e86]:
    - link "Edit with Lovable" [ref=e87] [cursor=pointer]:
      - /url: https://lovable.dev/projects/e72892f5-1e19-494d-a0dd-fac4aaf73da4?utm_source=lovable-badge
      - generic [ref=e88]: Edit with
      - img [ref=e89]
